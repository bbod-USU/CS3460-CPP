...
execute_process(
  COMMAND ${CMAKE_COMMAND} -E remove_directory "/Users/bradybodily/Repositories/CS3460/Hw7&8/cmake-build-debug/googletest-src"
...
if(error_code)
  message(FATAL_ERROR "Failed to update submodules in: '/Users/bradybodily/Repositories/CS3460/Hw7&8/cmake-build-debug/googletest-src'")
endif()
...
if(error_code)
  message(FATAL_ERROR "Failed to copy script-last-run stamp file: '/Users/bradybodily/Repositories/CS3460/Hw7&8/cmake-build-debug/googletest-download/googletest-prefix/src/googletest-stamp/googletest-gitclone-lastrun.txt'")
endif()
